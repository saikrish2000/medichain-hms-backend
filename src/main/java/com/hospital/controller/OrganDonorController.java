...
@RestController
@RequestMapping("/api/organ-donor")
@RequiredArgsConstructor
@Tag(name = "Organ Donor", description = "Organ donor registry and requests")
public class OrganDonorController {
    ...
    public ResponseEntity<?> dashboard() {
        return ResponseEntity.ok(organDonorService.getDashboardStats());
    }
    ...
    public ResponseEntity<?> donor(@PathVariable Long id) {
        return ResponseEntity.ok(organDonorService.getDonorById(id));
    }
